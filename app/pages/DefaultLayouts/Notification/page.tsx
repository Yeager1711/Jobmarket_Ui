...
const Notification: React.FC = () => {
    ...
    // Dữ liệu thông báo với trường imageUrl
    const notificationData = {
        text: 'JobMarket AI',
        text_des_1:
            '🚀 JobMarket AI đã ra mắt! Giúp bạn phân tích mức độ cạnh tranh với các ứng viên khác, tối ưu hóa hồ sơ để nổi bật hơn!',
        text_des_2:
            '🤖 Sử dụng AI để phân tích hồ sơ! Biết ngay điểm mạnh, điểm yếu và cơ hội của bạn so với các ứng viên khác.',
        text_des_3:
            '🎯 AI đánh giá hồ sơ của bạn! Cung cấp gợi ý cải thiện và tăng cơ hội trúng tuyển vào vị trí mong muốn.',
        text_des_4:
            '🔍 AI giúp bạn hiểu rõ thị trường! So sánh hồ sơ với đối thủ, tối ưu CV để thu hút nhà tuyển dụng.',
        text_des_5:
            '📊 Phân tích hồ sơ thông minh! AI đánh giá khả năng cạnh tranh của bạn và đề xuất hướng đi phù hợp.',
        startDate: '2025-03-20',
        endDate: '2025-04-20',
        imageUrl: '/images/AI/AI_banner.jpg',
    };

    useEffect(() => {
        // Kiểm tra ngày hiện tại để hiển thị thông báo
            ...
            <div className={styles.content}>
                <div className={styles.textContainer}>
                    <h3>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="15" viewBox="0 0 32 24" fill="none">
                            <path
                ...
                <div style={{ display: 'flex', gap: '2rem' }}>
                    ...
                    <div className={styles.textContainer}>
                        ...
                        <p><FontAwesomeIcon icon={faCheck} /> {notificationData.text_des_1}</p>
                        <p><FontAwesomeIcon icon={faCheck} />{notificationData.text_des_2}</p>
                        <p><FontAwesomeIcon icon={faCheck} />{notificationData.text_des_3}</p>
                        <p><FontAwesomeIcon icon={faCheck} />{notificationData.text_des_4}</p>
                        <p><FontAwesomeIcon icon={faCheck} />{notificationData.text_des_5}</p>
                    </div>
                </div>

                <button className={styles.btn_startNow}>Bắt đầu ngay</button>
