...
//             // Temporarily comment out PayOS integration due to maintenance
//             /*
...
//             // Replace with direct competitiveness analysis
//             const analysisResult = await analyzeCompetitiveness(jobId, selectedCV.resumeCVId);
//             showToastSuccess('Phân tích mức độ cạnh tranh CV đã hoàn tất!');
//             // Optionally redirect to results page
//             router.push(
//                 `/Auth/User/chatAI/result/compareCompetitiveness?orderCode=${123}&jobId=${jobId}&resumeCVId=${resumeCVId}`
//             );
//         } catch (error: any) {
...
//     const totalWithTax = basePrice; // Fixed typo from totalWithWtax to totalWithTax
...
//                     >
//                         {isProcessing ? 'Đang xử lý...' : 'Tiến hành phân tích'}
//                     </button>
//                 </div>
//             </div>
//         </section>
